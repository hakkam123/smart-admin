...
- `bankAccountNumber` (optional, string): Bank account number for payment transactions
- `bankName` (optional, string): Name of the bank (e.g., BCA, BNI, etc.)
- `bankHolderName` (optional, string): Account holder name for the bank account
